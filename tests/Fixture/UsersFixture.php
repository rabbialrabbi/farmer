...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'emailaddress' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-06-24 15:59:27',
                'modified' => '2020-06-24 15:59:27',
            ],
        ];
        parent::init();
    }
